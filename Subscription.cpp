...
Subscription::Subscription(int id, int traineeID,string startDate, int period) {
    this->id = id;
...
Subscription::Subscription(int id, int traineeID,string startDate, int period, string endDate, float price) {
	this->id = id;
	this->traineeID = traineeID;
	this->startDate = startDate;
